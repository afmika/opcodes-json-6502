...
((Instr::STP, AdrMode::IMPL), vec![Opcode::new(0x02, vec!["STP".to_string()]),
...
((Instr::NOP, AdrMode::ZPX), vec![Opcode::new(0x14, vec!["NOP $44,X".to_string()]),
...
((Instr::NOP, AdrMode::IMPL), vec![Opcode::new(0x1A, vec!["NOP".to_string()]),
...
((Instr::NOP, AdrMode::ABSX), vec![Opcode::new(0x1C, vec!["NOP $4400,X".to_string()]),
...
((Instr::NOP, AdrMode::IMM), vec![Opcode::new(0x80, vec!["NOP #$44".to_string()]),
...
((Instr::ANC, AdrMode::IMM), vec![Opcode::new(0x0B, vec!["ANC #$44".to_string()]),
...
((Instr::SBC, AdrMode::IMM), vec![Opcode::new(0xE9, vec!["SBC #$44".to_string()]),
